...
export default function App() {
  return (
    ...
    <div className='overflow-hidden bg-tranparent'>
    <div class=" w-full bg-black relative p-2">
    ...
    <div className='flex w-screen bg-white bottom-0 fixed rounded items-center justify-center text-center' >
    <div class="flex flex-row m-auto justify-between gap-3">
  <div class="basis-1/4 md:basis-1/3 p-4 pointer-events-auto  data">
...
<div class="basis-1/4 md:basis-1/3 p-4 ">
