...
function App() {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className='h-7 w-7 mr-3' fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
...
<br></br>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      ...
      <p class="text-gray-600 text-xs italic">Make sure you enter it corrently</p>
    </div>
  </div>
...
<button className='btn btn-outline btn-primary' type='button'>Submit</button>
</div>
