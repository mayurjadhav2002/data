    ...
    return (
        <div>
            ...
            <div className='hidden lg:block'>
                ...
                <section className="bg-white dark:bg-gray-900 py-3 mt-6">
                    <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">Empowering Electric Vehicles  <br></br><span className='text-green-600'>Using Seamless Charging</span></h1>
                ...
                <section className="bg-white dark:bg-gray-900">
                    <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
                        <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
                            ...
                            <a href="/" className="flex items-center lg:justify-center">
                            <img src='./TataMotors.png'></img>
                            </a>
                            <a href="/" className="flex items-center lg:justify-center">
                            <img src='./kia.png'></img>
                            </a>
                            <a href="/" className="flex items-center lg:justify-center">
                            <img src='./hyundai.png'></img>
                            </a>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                        ...
                        <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                                <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Demand of Electric power station</h2>
                                <p className="mb-8 font-light lg:text-xl">As the popularity of electric vehicles continues to grow, the demand for electric charging stations is also increasing. In response, governments and private companies are investing in the construction of more charging stations to support the widespread adoption of electric vehicles. This transition to electric vehicles and the infrastructure that supports it is an important step towards reducing greenhouse gas emissions and creating a more sustainable future.</p>
                                ...
                                <ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                                    <li className="flex space-x-3">
                                        ...
                                        <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Fastest route to nearby charging station.</span>
                                    </li>
                                    <li className="flex space-x-3">
                                        <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                        <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Avoid Queue Pre-booking of slots for charging.</span>
                                    </li>
                                    <li className="flex space-x-3">
                                        <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                        <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Battery replacement to your nearest Available place.</span>
                                    </li>
                                    <li className="flex space-x-3">
                                        <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                        <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Avoid needless wait for mechanics.</span>
                                    </li>
                                </ul>
                ...
                <section className="bg-white dark:bg-gray-900">
                    <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                        <div className="col-span-2 mb-8">
                            <p className="text-lg font-medium text-purple-600 dark:text-purple-500">Electric Industrialization</p>
                ...
                <section className="bg-gray-50 dark:bg-gray-800">
                    <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
                        <figure className="max-w-screen-md mx-auto">
                            ...
                            <blockquote>
                                <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"Electric cars are not going to take the market by storm, but it's going to be a gradual improvement.."</p>
                            </blockquote>
                            <figcaption className="flex items-center justify-center mt-6 space-x-3">
                                <img className="w-6 h-6 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="profile picture" />
                                <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                                    <div className="pr-3 font-medium text-gray-900 dark:text-white">Carlos Ghosn</div>
                                    <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">CEO of Michelin North America, chairman and CEO of Renault, chairman of AvtoVAZ, chairman and CEO of Nissan, and chairman of Mitsubishi Motors. </div>
                                </div>
                            </figcaption>
                        </figure>
                    </div>
            ...
            <div className='md:block lg:hidden'>
                ...
                >
                    ...
                    <SwiperSlide><div className='w-full h-full bg-slate-100 p-16 Hello'>Hello</div></SwiperSlide>
                    <SwiperSlide><div className='w-full h-full bg-slate-100 p-16 Hello'>Hello</div></SwiperSlide>
                    <SwiperSlide><div className='w-full h-full bg-slate-100 p-16 Hello'>Hello</div></SwiperSlide>
