    ...
    return (
        <>
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 md:py-8 py-0 mx-auto md:h-screen  lg:py-0">
                    <div className="w-full mt-10  rounded-lg  dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className=" space-y-4 md:space-y-6 sm:p-8">
                            <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                                Sign Up to Begin Jorney With Us
                            </h1>
                            <form className="space-y-4 md:space-y-6" action="/">
                                <div className="grid grid-cols-6 gap-6">
                                    <div className="col-span-6 ">
                                        <label for="first-name" className="block text-sm font-medium leading-6 text-gray-900">Name</label>
                                        <input type="text" name="name" id="first-name" autocomplete="given-name" onChange={onchange}
                                        placeholder="Sachine Tendulakar"
                                    ...
                                    <div className="col-span-6 ">
                                        ...
                                        placeholder='dummyemail@email.com'
                                        onChange={onchange} className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                    ...
                                    <div className="col-span-6">
                                        ...
                                        <input type="password" placeholder='************' name="password" id="street-address" onChange={onchange} autocomplete="street-address" className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>

                                    <div className="col-span-6 sm:col-span-6 lg:col-span-3">
                                        <label for="city" className="block text-sm font-medium leading-6 text-gray-900">Car Number</label>
                                        <input type="text" placeholder='MH CIT' name="carnumber" id="city" onChange={onchange} autocomplete="address-level2" className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                ...
                                className=" btn btn-primary w-full">Sign Up</button>
